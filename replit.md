...
### Database Migration (Local PostgreSQL)
- **Changed from**: Neon Database (serverless) to standard PostgreSQL
- **Benefits**: Better local development, Windows compatibility
- **Files modified**: `server/db.ts`, migration scripts created
- **Date**: January 2025
